...
int main(int argc, char *argv[])
{
    ...
    if(argc >= 2)
    {
        ...
        {
            if(argc == 2){     
                cout << RED "missing arguments!" END <<endl;  // FIX: Added END
            ...
            if(argc >= 3){
                if(argc == 3){
                    ...
                    {
                        // FIX: Changed argv[i] to argv[i+2]
        ...
        else if (argument == "commit")
        {
            if(argc == 4)    //[ git, commit, -m, "msg" ]
            {
                ...
                if(argumentC == "-m")
                {
                    ...
                    // REMOVED: "files commited successfully" message
                }
            }
            else 
            {
        ...
        else if(argument == "revert")
        {
            ...
            {
                string argumentC = string(argv[2]);
                // FIX: Removed special HEAD handling
